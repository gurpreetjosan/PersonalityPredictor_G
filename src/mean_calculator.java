...
public class mean_calculator {
    ...
    private double features[]=new double[31];
    ...
    private Pattern emoticon =     //pattren to find emojis in text
            Pattern.compile(
                    "[\ud83c\udc00-\ud83c\udfff]|[\ud83d\udc00-\ud83d\udfff]|[\u2600-\u27ff]|[\u20a0-\u32ff]|[\u0023-\u0039]|[\ud800-\udbff][\udc00-\udfff]}",
    ...
    private Matcher unicodeOutlierMatcher;
    ...
    public void readmsg() {
        ...
        try {
            fis = new FileInputStream("/home/gurpreet/Desktop/data-personality1");
            in = new InputStreamReader(fis, Charset.forName("UTF-8"));
            br = new BufferedReader(in);
            line = br.readLine();
            while (line != null) {
                if(line.equals("ਗ਼ਗ਼ਗ਼ਗ਼ਗ਼")) {
                    msgs.add(msg+"\n");
                    msg="";
                    line = br.readLine();
                    continue;
    ...
    public static void main(String[] args) {
        mean_calculator mc=new mean_calculator();
        mc.readmsg();
       // mc.tag_pos();
        mc.load_sentlex();
        mc.load_emoji();
        ...
        {
            mc.features[i]=Math.round(mc.features[i]/tot_msgs);
            System.out.println(mc.features[i]);
        }
